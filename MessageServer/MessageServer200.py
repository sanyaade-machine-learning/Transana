...
if len(sys.argv) > 1:
    try:
        ...
        if not RUNASWINSERVICE:
            ...
            print "        MessageServer200 17590    would launch the Message Server using port 17590."
...
if RUNASWINSERVICE:
    ...
    class TransanaMessageService(win32serviceutil.ServiceFramework):
        ...
        _svc_name_ = "TransanaMessageServer200"
        _svc_display_name_ = "Transana Message Server, v. 2.00"
