# Copyright (C) 2003 - 2011 The Board of Regents of the University of Wisconsin System 
#
    ...
    def run(self):
        ...
        while self.keepRunning:
            ...
            try:
                ...
                elif (data == 'M RESET USERS') and (self.parent.connections[self.address]['name'] == 'DavidW'):
        ...
        if DEBUG:
            ...
            for thr in threading.enumerate():
                if isinstance(thr, connectionThread):
                    print thr, self.connections[thr.address]['name']
            print "Connections:"
...
if RUNASWINSERVICE:
    ...
    class TransanaMessageService(win32serviceutil.ServiceFramework):
        ...
        _svc_display_name_ = "Transana Message Server, v. 2.60"
