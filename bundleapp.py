...
# Some globals
wxPythonLib = '/usr/local/lib/wxPython-ansi-2.5.3.1/lib/'
...
#            wxPythonLib + 'libwx_macd_stc-2.5.1.dylib',
            wxPythonLib + 'libwx_macd_stc-2.5.3.dylib',
...
# Create a compressed disk image for distribution
# os.chdir('build')
# os.system('hdiutil create -srcfolder Transana.app Transana.dmg')
# os.system('hdiutil create -srcfolder Help.app Help.dmg')
