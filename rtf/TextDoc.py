...
#   hyperlinks in document output. Produces active links in HTML, RTF,
#   and PDF generated from LaTeX using LaTeX2PdfDoc class. Links will be
#   represented as text in other generator output. (active links are
#   technically possible in PDF documents generated by PdfDoc class,
#   but the reportlab modules the generator is based on does not support
#   them at this time)
#
#   Added borderWidth and borderColor attributes to ParagraphStyle.
#
...
class ParagraphStyle:
    ...
    border, border width, border color, padding, and background color.
    ...
    def __init__(self,source=None):
	    ...
	    self.bordercolor = source.bordercolor
	    self.borderwidth = source.borderwidth
        else:
            self.font    = FontStyle()
            self.rmargin = 0
            self.lmargin = 0
    ...
    def set(self,rmargin=None,lmargin=None,first_indent=None,align=None,
            ...
            bgcolor=None,font=None,bordercolor=None,borderwidth=None):
        """
	...
	bordercolor - color of any border line
	borderwidth - width of any border line in points
        """
        if font != None:
	...
	if borderwidth != None:
	    self.set_border_width(borderwidth)
    ...
    def get_border_color(self):
        """
        Returns a tuple indicating the RGB components of the border
        color
        """
    ...
    def set_border_color(self,color):
        """
        Sets the border color of the paragraph.
